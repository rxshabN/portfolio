  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="name sm:text-7xl text-5xl font-medium capitalize mb-8">
          About me
        </h2>
        <div className="sm:grid sm:grid-cols-2 flex flex-col sm:gap-x-20 max-w-[75rem]">
          <div className="mb-3 text-center sm:text-start sm:flex sm:flex-col sm:gap-y-5 sm:text-2xl text-base px-10">
            <div className="sm:space-y-6 space-y-4">
              <div className="flex items-start gap-4">
                <p className="leading-relaxed">
                  ⭐ I'm a passionate <b>Web Developer</b> from Mumbai.
                </p>
              </div>
              <div className="flex items-start gap-4">
                <p className="leading-relaxed">
                  💻 I specialize in <b>MERN stack</b> technology{" "}
                  <i>(MongoDB, Express.js, React, Node.js).</i> I also have
                  experience with <b>Python, C++, and Java.</b>
                </p>
              </div>
              <div className="flex items-start gap-4">
                <p className="leading-relaxed">
          ...
          <div className="mb-3 text-center sm:text-justify sm:flex sm:flex-col sm:gap-y-5 sm:text-2xl text-base px-10">
            <div className="sm:space-y-6 space-y-4">
              <div className="flex items-start gap-4">
                <p className="leading-relaxed">
                  I’m driven by a passion for tackling{" "}
                  <b>real-world challenges</b> and creating{" "}
                  <b>impactful solutions </b>
                  through technology. It’s this pursuit of knowledge and{" "}
                  <b>hands-on learning</b> that fuels my desire to contribute
